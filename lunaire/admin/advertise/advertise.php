...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="header">Edit/Delete Advertisement Entry</td>
  </tr>
  <tr>
    <td class="body">
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="added"){
				print "<em>Advertisement was added successfully.</em><br />";
			}
		} ?>
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="success"){
				print "<em>Advertisement was deleted successfully.</em><br />";
			}
		} ?>
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="edit_success"){
				print "<em>Your advertisement has been editted successfully.</em><br />";
			}
		} ?>
...
$query = "select * from `advertise` order by ad_id desc"; 
...
{ 
    ...
    echo "<tr> <td class=\"edit\">$ad_id</td><td class=\"edit\">$name</td><td class=\"edit\" align=\"center\"><img src=\"$banner\" width=\"150\" height=\"26\" border=\"0\" /></td><td class=\"edit\"><a href=\"process.php?what=delete&ad=$ad_id\">Delete</a></td><td class=\"edit\"><a href=\"process.php?what=edit&ad=$ad_id\">Edit</a></td>"; } echo "</table>"; 
