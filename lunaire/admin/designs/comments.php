...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="header">Edit/Delete Design Comment</td>
  </tr>
  <tr>
    <td class="body">
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="added"){
				print "<em>Comment was added successfully.</em><br />";
			}
		} ?>
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="success"){
				print "<em>Comment was deleted successfully.</em><br />";
			}
		} ?>
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="edit_success"){
				print "<em>Your comment has been edited successfully.</em><br />";
			}
		} ?>
...
$query = "select * from `design_comments` order by id desc"; 
...
{ 
    ...
    echo "<tr><td class=\"edit\">$id</td>
              <td class=\"edit\">$entry</td>
              <td class=\"edit\"><a href=\"$url\" target=\"_blank\">$name</a></td>
              <td class=\"edit\" align\"center\"><a href=\"mailto:$email\">Email</a></td>
              <td class=\"edit\" align\"center\">$comment</td>
              <td class=\"edit\"><a href=\"process.php?what=commentdelete&id=$id\">Delete</a></td>
              <td class=\"edit\"><a href=\"process.php?what=commentedit&id=$id\">Edit</a></td>"; } 
    echo "</table>"; 
