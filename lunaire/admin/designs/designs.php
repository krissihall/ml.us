...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="header">Edit/Delete Design Entry</td>
  </tr>
  <tr>
    <td class="body">
     Please choose a design to edit or delete <br />
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="added"){
				print "<em>Design was added successfully.</em><br />";
			}
		} ?>
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="success"){
				print "<em>Design was deleted successfully.</em><br />";
			}
		} ?>
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="edit_success"){
				print "<em>Your design has been edited successfully.</em><br />";
			}
		} ?>
	...
	//if user was sent here from process page, add this error message
		if(isset($_GET['z'])){
			if ($_GET['z']=="successful"){
				print "<em>Your design was added successfully.</em><br />";
			}
		} ?>
...
$query = "select * from `designs` order by id desc"; 
...
{ 
    ...
    echo "<tr> <td class=\"edit\">$id</td><td class=\"edit\">$name</td><td class=\"edit\">$designer</td><td class=\"edit\" align=\"center\"><img src=\"$image\" width=\"100\" height=\"75\" border=\"0\" /></td><td class=\"edit\"><a href=\"process.php?what=delete&design=$id\">Delete</a></td><td class=\"edit\"><a href=\"process.php?what=edit&design=$id\">Edit</a></td>"; } echo "</table>"; 
